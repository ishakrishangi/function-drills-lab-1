...
//CODE HERE
function helloName(personsName){
...
//CODE HERE
function sumParameters (para1, para2){
 return parseInt(para1) + parseInt(para2)
}
let sum = sumParameters(33, "100")
console.log(sum)
...
console.log(exclaimThree('i am so confused'))
...
//CODE HERE
function theEliminator(array1, string){
...
console.log(emailCheck("   sdfsdf@asklk.oohhs    "))
...
//CODE HERE
function maxFrogs2(gold){
  return Math.floor(gold/3)
}

let totalFrogs2 = maxFrogs2(67);
...
function ascendingArr(inputArray){
